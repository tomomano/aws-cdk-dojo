...
ECS_CLUSTER_NAME = os.env["ECS_CLUSTER_NAME"]
ECS_TASK_DEFINITION = os.env["ECS_TASK_DEFINITION"]
ECS_TASK_VPC_SUBNET_1 = os.env["ECS_TASK_VPC_SUBNET_1"]
ECS_TASK_VPC_SUBNET_2 = os.env["ECS_TASK_VPC_SUBNET_2"]
OUTPUT_S3_PATH = os.env["OUTPUT_S3_PATH"]
OUTPUT_S3_AWS_REGION = os.env["OUTPUT_S3_AWS_REGION"]
